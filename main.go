...
import (
	...
	pb "github.com/rajeshreddyt/GrpcServerDivision/DIVISION"
)
...
func (s *server) DivisionMethod(ctx context.Context, req *pb.DivisionRequest) (*pb.DivisionResponse, error) {
	...
	// 	Operation: pb.ComputationRequest_DIVISION,
	// }
